...
const useAuthStore = (0, zustand_1.create)((set) => ({
    ...
    jwtExpired: {
        ...
        setJwtExpiredThing: (isExpired) => set((state) => ({
            jwtExpired: {
                ...state.jwtExpired,
    ...
    isCollabo: {
        collaboClick: "",
        setCollaboClick: (collabo) => set((state) => ({
            isCollabo: {
                ...state.isCollabo,
    ...
    collaboResultData: {
        collaboResult: "",
        setCollaboResult: (result) => set((state) => ({
            collaboResultData: {
    ...
    alertState: {
        alertMessage: "",
        showAlert: false,
        setAllertMessage: (result) => set((state) => ({
            alertState: {
                ...state.alertState,
                alertMessage: result,
                showAlert: true,
        ...
        setConfirmAction: (action) => set((state) => ({
            alertState: {
                ...state.alertState,
    ...
    jwtGlobal: {
        ...
        setJwtDecodingData: (jwtData) => set((state) => ({
            jwtGlobal: {
                ...state.jwtGlobal,
    ...
    mainContentsGlobal: {
        mainContentsData: [],
        setMainContentsData: (mainData) => set((state) => ({
            mainContentsGlobal: {
    ...
    mainMountRenderData: {
        mainMountData: [],
        setMainMountData: (mountData) => set((state) => ({
            mainMountRenderData: {
    ...
    researchInputGlobal: {
        researchInputData: "",
        setReserchInputData: (inputData) => set((state) => ({
            researchInputGlobal: {
    ...
    pagiNationMenubar: {
        numberData: null,
        setNumberData: (number) => set((state) => ({
            pagiNationMenubar: {
...
//# sourceMappingURL=GlobalState.jsx.map