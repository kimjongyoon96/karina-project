...
router.delete("/api/deleteMyPage", jwt_1.verifyToken, async (req, res) => {
    ...
    try {
        if (selected === "myWrite") {
            console.log("내게시물삭제");
            const myRepository = ORM_1.ormConnection.getRepository(userInfoEntity_1.userInfoData);
            ...
            const commnetRepository = ORM_1.ormConnection.getRepository(userCommentsEntity_1.userComment);
...
//# sourceMappingURL=myPageDelete.js.map