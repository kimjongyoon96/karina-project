...
exports.CreateMigration1718104929361 = void 0;
class CreateMigration1718104929361 {
    name = 'CreateMigration1718104929361';
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "userinfodata" ("id" SERIAL NOT NULL, "username" character varying(255), "userId" character varying(255), "useremail" character varying(255), "userNickName" character varying(255), "userPassWord" character varying(255), "loginType" character varying NOT NULL DEFAULT false, CONSTRAINT "PK_ce20abbb1c0d88e110277fd9adc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "userpost" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL, "menubar" character varying(255), "title" character varying(255), "photosumnail" character varying(255), "photos" text array NOT NULL DEFAULT '{}', "userNickName" character varying(255), "socialUserId" integer, "nonSocialUserId" integer, CONSTRAINT "PK_9fb6ab83991c7c763ad8187120b" PRIMARY KEY ("id"))`);
...
exports.CreateMigration1718104929361 = CreateMigration1718104929361;
