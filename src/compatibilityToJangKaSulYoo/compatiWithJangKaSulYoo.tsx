...
import karianSelected from "../assets/photo/karinaSelected.gif";
...
const CompatiWithJangKaSuYoo: React.FC = () => {
  ...
  const handleImage = (newMenubar) => {
    ...
    console.log(bringImage, "이미지가 뭐가나오나 보자이기");
  };
  ...
  return (
    <main className="compatibility-box">
      ...
      <section className="right-gif-box">
        <img src={karianSelected} alt="카리나이미지"></img>
      </section>
    </main>
  );
};
...
//* 그 컴포넌트는 결과값을 렌더링, 중앙에 결과값, 천생연분,보통,나쁜,상극 에 따라서 경우의수 16가지 gif
//* 총 20개의 gif가 필요
